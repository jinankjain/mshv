...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialOrd, Ord, PartialEq, Eq)]
pub struct mshv_user_irq_entry_irqchip {
    pub irqchip: __u32,
    pub pin: __u32,
}
#[test]
fn bindgen_test_layout_mshv_user_irq_entry_irqchip() {
    const UNINIT: ::std::mem::MaybeUninit<mshv_user_irq_entry_irqchip> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<mshv_user_irq_entry_irqchip>(),
        8usize,
        concat!("Size of: ", stringify!(mshv_user_irq_entry_irqchip))
    );
    assert_eq!(
        ::std::mem::align_of::<mshv_user_irq_entry_irqchip>(),
        4usize,
        concat!("Alignment of ", stringify!(mshv_user_irq_entry_irqchip))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(mshv_user_irq_entry_irqchip),
            "::",
            stringify!(irqchip)
        )
    );
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialOrd, Ord, PartialEq, Eq)]
pub struct mshv_user_irq_entry_msi {
...
#[test]
fn bindgen_test_layout_mshv_user_irq_entry_msi() {
    const UNINIT: ::std::mem::MaybeUninit<mshv_user_irq_entry_msi> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<mshv_user_irq_entry_msi>(),
        16usize,
        concat!("Size of: ", stringify!(mshv_user_irq_entry_msi))
    );
    assert_eq!(
        ::std::mem::align_of::<mshv_user_irq_entry_msi>(),
        4usize,
        concat!("Alignment of ", stringify!(mshv_user_irq_entry_msi))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(mshv_user_irq_entry_msi),
            "::",
...
pub struct mshv_user_irq_entry {
    ...
    pub type_: __u32,
    pub pad: __u64,
    pub u: mshv_user_irq_entry__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union mshv_user_irq_entry__bindgen_ty_1 {
    pub irqchip: mshv_user_irq_entry_irqchip,
    pub msi: mshv_user_irq_entry_msi,
    pub pad: [__u32; 8usize],
}
#[test]
fn bindgen_test_layout_mshv_user_irq_entry__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<mshv_user_irq_entry__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<mshv_user_irq_entry__bindgen_ty_1>(),
        32usize,
        concat!("Size of: ", stringify!(mshv_user_irq_entry__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<mshv_user_irq_entry__bindgen_ty_1>(),
        4usize,
        concat!(
            "Alignment of ",
            stringify!(mshv_user_irq_entry__bindgen_ty_1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).irqchip) as usize - ptr as usize },
...
impl Default for mshv_user_irq_entry__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for mshv_user_irq_entry {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for mshv_user_irq_table {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
